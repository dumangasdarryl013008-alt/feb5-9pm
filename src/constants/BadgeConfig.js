  ...
  NORMAL: [
    {
      ...
      description: "Reach 40+ WPM within 60 seconds",
      requirement: {
        type: "wpm_in_time",
        target: 40,
        timeLimit: 60,
    ...
    },
    {
      ...
      name: "Quick Learner",
      tier: BADGE_TIERS.BRONZE,
      description: "Improve score 3 times within 90 seconds",
      requirement: {
        type: "improvements_in_time",
        target: 3,
        timeLimit: 90,
      },
      getProgress: (stats) => ({
    ...
    },
    {
      ...
      description: "95%+ accuracy in a 30s session",
      requirement: {
        type: "accuracy_in_time",
        target: 95,
        timeLimit: 30,
      },
      getProgress: (stats) => ({
    ...
    },
    {
      ...
      name: "Focus Finder",
      tier: BADGE_TIERS.SILVER,
      description: "Complete 60s without pausing",
      requirement: {
        type: "no_pause_in_time",
        target: 60,
      },
      getProgress: (stats) => ({
    ...
    },
    {
      ...
      description: "Earn 200+ points in 60 seconds",
      requirement: {
        type: "points_in_time",
        target: 200,
        timeLimit: 60,
  ...
  COMBO: [
    {
      ...
      name: "Blast Champ",
      tier: BADGE_TIERS.BRONZE,
      description: "Reach a 20-word blast streak",
      requirement: {
        type: "combo_streak",
        target: 20,
      },
    ...
    },
    {
      ...
      name: "Streak Master",
      tier: BADGE_TIERS.GOLD,
      description: "Keep your blast streak going for 1 full minute",
      requirement: {
        type: "combo_duration",
        target: 60,
      },
    ...
    },
    {
      ...
      name: "Blast Marathon",
      tier: BADGE_TIERS.GOLD,
      description: "Earn 50+ bonus seconds in one session",
      requirement: {
        type: "bonus_seconds",
        target: 50,
      },
    ...
    },
    {
      ...
      name: "Blast God",
      tier: BADGE_TIERS.STAR,
      description: "Earn 100+ bonus seconds in one session",
      requirement: {
        type: "bonus_seconds",
        target: 100,
      },
      getProgress: (stats) => ({
        current: stats.bonusSeconds || 0,
        target: 100,
        percentage: Math.min(100, ((stats.bonusSeconds || 0) / 100) * 100),
      }),
    },
    {
      id: "combo_starter",
      name: "Blast Starter",
      tier: BADGE_TIERS.BRONZE,
      description: "Build a 10-word blast streak",
      requirement: {
        type: "combo_streak",
        target: 10,
      },
    ...
    },
    {
      ...
      name: "Blast Builder",
      tier: BADGE_TIERS.SILVER,
      description: "Reach a 40-word blast streak",
      requirement: {
        type: "combo_streak",
        target: 40,
      },
    ...
    },
    {
      ...
      name: "Blast Master Supreme",
      tier: BADGE_TIERS.STAR,
      description: "Maintain blast streak for 2 full minutes",
      requirement: {
        type: "combo_duration",
        target: 120,
      },
