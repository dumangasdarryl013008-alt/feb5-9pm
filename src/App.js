...
function App() {
  ...
  // Fix: Move derived state into useMemo to avoid potential hook ordering issues or redundant calculations
  const isWordGameMode = useMemo(() => 
    gameMode === GAME_MODE_DEFAULT &&
    !isCoffeeMode &&
    !isTrainerMode &&
    !isWordsCardMode,
  [gameMode, isCoffeeMode, isTrainerMode, isWordsCardMode]);

  const isSentenceGameMode = useMemo(() => 
  ...
  const handleTypingGameModeChange = (newMode) => {
    if (newMode === "QWERTY") {
    ...
    <ThemeProvider theme={theme}>
      <>
        ...
        <div className="canvas">
          <GameGuide open={showGuide} onClose={() => setShowGuide(false)} />
          ...
          {isWordGameMode && (
            <TypeBox
              ...
              setTypingGameMode={handleTypingGameModeChange}
